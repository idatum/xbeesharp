...
public class TransmitPacketTest
{
    ...
    public void LargePayloadUnescaped()
    {
        ...
        XbeeFrame? xbeeFrame;
        bool created = XbeeTransmitPacket.CreateXbeeFrame(out xbeeFrame, Address, reasonablyLargePayload, false);
    ...
    public void LargePayloadEscaped()
    {
        ...
        XbeeFrame? xbeeFrame;
        bool created = XbeeTransmitPacket.CreateXbeeFrame(out xbeeFrame, Address, reasonablyLargePayload, true);
        Xunit.Assert.NotNull(xbeeFrame);
        Xunit.Assert.True(created);
    }
}
